	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">맛집 공유하기
				...
				<button type="button" onclick="location.href='/board/list?bno=${cri.bno}&Type=${cri.Type}&keyword=${cri.keyword}&sort=bno'" class="btn btn-outline-dark float-right ">최신순</button>
				<button type="button" onclick="location.href='/board/list?bno=${cri.bno}&Type=${cri.Type}&keyword=${cri.keyword}&sort=hitCount'" class="btn btn-outline-dark float-right " >조회순</button>
				<button type="button" onclick="location.href='/board/list?bno=${cri.bno}&Type=${cri.Type}&keyword=${cri.keyword}&sort=likeCount'" class="btn btn-outline-dark float-right" data-bs-toggle="button" >추천순</button>
				<a href="/board/list?hit=${board.hit}">&nbsp&nbsp조회순&nbsp&nbsp</a>|
					...
					<form action="/board/list" method="get">
						<input type="hidden" name="likehit" value="1">
						<input class="btn btn-link-dark" type="submit" value="추천순">
					</form>
				<!-- <option value="B" <c:out value="${pageMaker.cri.type eq 'B'?'selected':''}"/>>최신순</option>
				<option value="H" <c:out value="${pageMaker.cri.type eq 'H'?'selected':''}"/>>조회순</option>
				<option value="L" <c:out value="${pageMaker.cri.type eq 'L'?'selected':''}"/>>추천순</option>
				<!-- <div>
					<a href="/board/list?bno=${board.bno}">최신순&nbsp&nbsp</a>|
					<a href="/board/list?hit=${board.hit}">&nbsp&nbsp조회순&nbsp&nbsp</a>|
					<a href="/board/list?likehit=${board.likehit}">&nbsp&nbsp추천순</a>
				</div> -->
